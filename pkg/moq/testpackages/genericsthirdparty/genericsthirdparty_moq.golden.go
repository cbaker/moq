...
type GenericStoreMock struct {
	...
	CreateFunc func(ctx context.Context, item Item[thirdparty.Item])

	// GetFunc mocks the Get method.
	GetFunc func(ctx context.Context, item Item[thirdparty.Item])
...
func (mock *GenericStoreMock) Create(ctx context.Context, item Item[thirdparty.Item]) {
...
// Get calls GetFunc.
func (mock *GenericStoreMock) Get(ctx context.Context, item Item[thirdparty.Item]) {
	if mock.GetFunc == nil {
